...
axs[0,0].set_xticks(np.arange(min(temp_list), max(temp_list)+1, 1.0))
...
axs[0,1].set_xticks(np.arange(min(temp_list), max(temp_list)+1, 1.0))
...
axs[1,0].set_xticks(np.arange(min(temp_list), max(temp_list)+1, 1.0))
