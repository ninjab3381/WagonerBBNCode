...
C              ----  ---- -- -- -- -- --------- -------
     ...
     |           104.,3.,27.,3.,6.,29.,     0 ,   77.23,      ! HeH(D,He)HD+
     ...
     |           113.,3.,28.,0.,6., 2.,     0 ,   77.23,      ! HeD+(e-,He)D
     |           114.,3.,29.,1.,2., 2.,     0 ,   77.23,      ! HD+(p,d)H2
     |           115.,3.,27.,2.,1.,28.,     0 ,   77.23,      ! HeH+(d,p)HeD+
     |           116.,3.,29.,2.,1.,30.,     0 ,   77.23,      ! HD+(d,p)H2D+
     |           117.,3.,27.,2.,1.,30.,     0 ,   77.23,      ! H3+(d,p)H2D+
     |           118.,3.,27.,0.,1.,28.,     0 ,   77.23,      ! H2D+(e-,p)HD+
     |           119.,3.,27.,0.,1., 2.,     0 ,   77.23,      ! H2D+(e-,d)D+
     |           120.,3.,27.,0.,1., 2.,     0 ,   77.23,      ! H2D+(e-,2p)D+
     |           121.,3., 4.,0.,2., 3.,     0 ,   77.23,      ! H3+(e-,p)D
     |           122.,3., 4.,0.,2., 2.,     0 ,   77.23,      ! H3+(e-,2p)p
     |           123.,3., 4.,1.,3., 3.,     0 ,   77.23/      ! H3+(H-,2p)D
