...
C              ----  ---- -- -- -- -- --------- -------
     ...
     |            21.,2., 4.,2.,0., 6., 102.61 , 229.932,  !H3(p,g)He4
...
C              reac# type n1 n2 n3 n4 rev-coeff q-value
C              ----  ---- -- -- -- -- --------- -------
     |            89.,2., 6.,2.,0.,27.,    0 ,   7.23,      ! He+(H,γ)HeH+
     |            90.,2., 3.,2.,0., 4.,    0,    1,         ! H2(p,γ)H3+ [46,47]
     |            91.,3.,27.,3.,6., 4.,    0 ,   7.23,      ! HeH(d,He)H3+
     |            92.,3., 6.,3.,2.,27.,    0 ,   7.23,      ! He(H2+,H)HeH+
     |            93.,2., 6.,2.,0.,27.,    0 ,   7.23,      ! He+(p,γ)HeH+
     |            94.,2., 6.,2.,0.,27.,    0 ,   7.23,      ! He+(pγ,2γ)HeH+
     |            95.,3., 3.,2.,0., 4.,    0 ,   7.23,      ! H2(p,e-)H3+
     |            96.,2., 6.,3.,0.,28.,    0 ,   7.23,      ! He+(d,γ)HeD+
     |            97.,3.,28.,2.,3.,27.,    0 ,   7.23,      ! HeD+(p,d)HeH+
     |            98.,2., 3.,2.,0.,29.,    1e-4 , 7.23,      ! D(p,γ)HD+
     |            99.,3.,29.,3.,3., 4.,    0 ,   7.23,      ! HD+(H2,d)H3+
     |           100.,3.,29.,1.,2., 3.,    1e-4 , 5.23,   ! HD+(e-,p)d
     |           101.,3.,29.,2.,3., 3.,    1e-4 , 5.23,   ! HD+(p,H2)d
     |           102.,3., 3.,3.,2.,29.,    1e-4 , 5.23,      ! D(d,p)HD+
     |           103.,3.,27.,3.,6., 4.,    0 ,   5.23,      ! HeH(d,He)H3+ [45]
     |           104.,3.,27.,3.,6.,29.,    0 ,   5.23,      ! HeH(D,He)HD+
     |           105.,3.,6.,29.,3.,27.,    0 ,   5.23,      ! He(HD+,d)HeH+
     |           106.,3.,6.,29.,2.,28.,    1e-6 ,   7.23,      ! He(HD+,p)HeD+
     |           107.,3.,4.,29.,3.,30.,    1e8 ,   777.23,  ! H3(HD+,d)H2D+
     |           108.,3.,30.,2.,3., 4.,    0 ,   1.23,      ! H2D+(p,d)H3+
     |           109.,3.,30.,3.,29.,4.,    0 ,   1.23,      ! H2D+(d,HD)H3+
     |           110.,2., 3.,3.,0.,30.,    1e-6 ,   1.23,      ! H2(d,γ)H2D+
     |           111.,2.,29.,2.,0.,30.,    1e-6 ,   7.23,   ! HD(p,γ)H2D+
     |           112.,3.,28.,2.,6.,29.,    1e-6 ,   7.23,      ! HeD+(p,He)HD+
     |           113.,3.,28.,1.,6., 2.,    1e-6 ,   7.23,      ! HeD+(e-,He)D
     |           114.,3.,29.,2.,3., 3.,    1e-6 ,   7.23,      ! HD+(p,d)H2
     |           115.,3.,27.,3.,2.,28.,    1e-6 ,   77.23,      ! HeH+(d,p)HeD+
     |           116.,3.,29.,3.,2.,30.,    1e-2 ,   7.23,      ! HD+(d,p)H2D+
     |           117.,3., 4.,3.,2.,30.,    1e8 ,   777.23,      ! H3+(d,p)H2D+
     |           118.,3.,27.,1.,2.,29.,    1e-3 ,   7.23,      ! H2D+(e-,p)HD+
     |           119.,3.,27.,1.,3., 3.,    1e-3 ,   7.23,      ! H2D+(e-,d)D+
     |           120.,9.,27.,1.,3., 2.,    1e-3 ,   7.23,      ! H2D+(e-,2p)D+
     |           121.,3., 4.,1.,2., 3.,    1e4 ,   777.23,      ! H3+(e-,p)D
     |           122.,9., 4.,1.,2., 2.,    1e4,    777.23,      ! H3+(e-,2p)p
     |           123.,9., 4.,2.,3., 2.,    1e4 ,   777.23/      ! H3+(H-,2p)D
